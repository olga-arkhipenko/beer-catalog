var Beer = require('../../view/models/Beer');
var foodPairingMapper = require('./foodPairingMapper');
var brewingMapper = require('./brewingMapper');

module.exports = {
    mapToBeer: function mapToBeer(beer) {
        var mappedBeer = new Beer();
        ...
        mappedBeer.brewing = brewingMapper.mapBrewing(beer.brewers_tips, beer.ingredients, beer.method);
